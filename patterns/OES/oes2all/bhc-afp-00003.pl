...
# Title:       AFP Basic Service Pattern
# Description: Checks Novell Apple File Protocol (AFP) to see if the service is installed, valid and running
...
my $CHECK_PACKAGE = "novell-afptcpd";
my $CHECK_SERVICE = "novell-afptcpd";
my $FILE_SERVICE = "novell-afp.txt";
